    ...
    <Card bodyStyle={{ padding: 0 }}>
      ...
      <List
        ...
        renderItem={item => (
          <>
            <List.Item>
              <div className='w-full' onClick={() => navigate(`/resource-preview/${item}`)}>
                <h3 className='leading-[42px] truncate cursor-pointer'>
                  ...
                  <a className='text-[18px] font-bold'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi ut quibusdam
                    quasi, ipsum accusamus delectus excepturi quos impedit, aspernatur corrupti
                    molestias voluptatem consequuntur perferendis voluptates optio quas veniam.
                    Architecto, quod.
                  </a>
                </h3>
                <div>
                ...
                <div className='flex justify-between items-center gap-[16px] mt-[16px]'>
                  <div className='flex-1 flex flex-wrap gap-[8px]'>
                    {['六校联盟创新创业大赛', '上海市医药学校'].map((item, index) => (
                      <span
